...
*/
@TableName("shuizhi")
public class ShuizhiView extends ShuizhiEntity implements Serializable {
	...
	* 水质状态的值
	*/
	@ColumnInfo(comment="水质状态的字典表值",type="varchar(200)")
	private String shuizhiValue;
	...
	public ShuizhiView(ShuizhiEntity shuizhiEntity) {
		try {
			BeanUtils.copyProperties(this, shuizhiEntity);
	...
	* 获取： 水质状态的值
	*/
	public String getShuizhiValue() {
		return shuizhiValue;
	}
	/**
	* 设置： 水质状态的值
	*/
	public void setShuizhiValue(String shuizhiValue) {
		this.shuizhiValue = shuizhiValue;
	}
