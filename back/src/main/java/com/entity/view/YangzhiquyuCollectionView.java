...
public class YangzhiquyuCollectionView extends YangzhiquyuCollectionEntity implements Serializable {
	...
	*/
	...
	private String yangzhiquyuCollectionValue;
	...
	public YangzhiquyuCollectionView() {

	}

	public YangzhiquyuCollectionView(YangzhiquyuCollectionEntity yangzhiquyuCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, yangzhiquyuCollectionEntity);
	...
	* 获取： 类型的值
	*/
	public String getYangzhiquyuCollectionValue() {
		return yangzhiquyuCollectionValue;
	}
	/**
	* 设置： 类型的值
	*/
	public void setYangzhiquyuCollectionValue(String yangzhiquyuCollectionValue) {
		this.yangzhiquyuCollectionValue = yangzhiquyuCollectionValue;
	}
	...
	public String toString() {
		return "YangzhiquyuCollectionView{" +
			", yangzhiquyuCollectionValue=" + yangzhiquyuCollectionValue +
