...
*/
@TableName("shuichan")
public class ShuichanView extends ShuichanEntity implements Serializable {
	...
	*/
	...
	public ShuichanView(ShuichanEntity shuichanEntity) {
		try {
			BeanUtils.copyProperties(this, shuichanEntity);
