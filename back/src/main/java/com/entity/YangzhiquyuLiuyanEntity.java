...
public class YangzhiquyuLiuyanEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public YangzhiquyuLiuyanEntity() {

	}

	public YangzhiquyuLiuyanEntity(T t) {
		try {
    ...
    public String toString() {
        return "YangzhiquyuLiuyan{" +
            ", id=" + id +
            ", yangzhiquyuId=" + yangzhiquyuId +
            ", yonghuId=" + yonghuId +
            ", yangzhiquyuLiuyanText=" + yangzhiquyuLiuyanText +
