...
var centerMenu = [
    ...
    ,{
        name: '养殖区域收藏',
        url: '../yangzhiquyuCollection/list.html'
    }
    ,{
        name: '我养殖的水产',
        url: '../shuichan/list2.html'
    }
    ,{
        name: '水产收藏',
        url: '../shuichanCollection/list.html'
    }
    ,{
        name: '我记录的水质',
        url: '../shuizhi/list.html'
    }
    ,{
        name: '饲料',
        url: '../siliao/list.html'
    }
    ,{
        name: '饲料使用',
        url: '../siliaoShiyong/list.html'
    }
...
var indexNav = [
    ...
    {
        name: '水产',
        url: './pages/shuichan/list.html'
    },
    {
        name: '养殖区域',
        url: './pages/yangzhiquyu/list.html'
    },

]

// 已废弃,不用了
var adminurl =  "http://localhost:8080/shuichanyangzhi/admin/dist/index.html#/login";
